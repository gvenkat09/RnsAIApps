...
st.markdown("## Get Ready on Professional Skills Evaluation")
...
auto_play = False # st.checkbox("Let AI interviewer speak! (Please don't switch during the interview)")
...
if jd and st.session_state["authentication_status"]:
    # initialize session states
    ...
    if feedback:
        ...
        with answer_placeholder:
            voice: bool = False # st.checkbox("I would like to speak with AI Interviewer")
            if voice:
